...
const SelectFault = t.enums.of(['N/A','lighting problem', 'switch not working', 'water heater'], SelectFault)
...
export default class ElectricalsScreen extends Component{
  constructor(props){
    super(props)
      ...
      <ScrollView style={styles.bigContainer}>
        ...
        <ScrollView style={styles.scrollview}>
          ...
          <Text style={[styles.viewText, {fontSize: 16}]}>
            ...
            2. All other items the electrician may need to buy, like components are to be covered by you, the customer {'\n'}
