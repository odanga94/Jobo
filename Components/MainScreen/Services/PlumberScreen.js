...
const SelectFault = t.enums.of(['N/A','drainage blocked', 'toilet problem', 'leaking sink'], SelectFault)
...
export default class PlumberScreen extends Component{
  constructor(props){
    super(props)
          ...
          <Form options={options} ref="form" type={plumbingDetails} onChange={this.handleChange.bind(this)} value={this.state.value} />
            <ScrollView style={styles.scrollview}>
              ...
              <Text style={[styles.viewText, {fontSize: 16}]}>
                ...
                2. All other items the plumber may need to buy, like components are to be covered by you, the customer {'\n'}
