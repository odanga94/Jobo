...
const technicianDetails = t.struct({
        ...
        <Stepper
          ...
          inactiveStepNumberStyle={styles.inactiveStepNumber}>
            <ScrollView style={styles.bigContainer}>
              <Form options={options} ref="form" type={technicianDetails} onChange={this.handleChange.bind(this)} value={this.state.value} />
            ...
            <ScrollView style={styles.bigContainer}>
              ...
              <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
                ...
                <TouchableHighlight style={[styles.button, {marginTop: 20, flex: 2}]} onPress={this.handleSubmit} underlayColor='white'>
                  <Text style={styles.buttonText}>Request for IT Tech</Text>
                </TouchableHighlight>
              </View>
            </ScrollView>
        </Stepper>
